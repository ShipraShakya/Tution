...
<div class="icons">
    ...
    <section class="menu" id="menu" data-aos="fade-right">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="#k1" class="btn">Read More</a>
            </div>

            <div class="box">
                <img src="images/pic2.jpg" alt="">
                <h3>Lower Cost</h3>
                <a href="#k2" class="btn">Read More</a>
            </div>

            <div class="box">
                <img src="images/pic3.jpg" alt="">
                <h3>Comfort</h3>
                <a href="#k3" class="btn">Read More</a>
            </div>

            <div class="box">
                <img src="images/pic4.jpg" alt="">
                <h3>Flexible Schedule</h3>
                <a href="#k4" class="btn">Read More</a>
            </div>

            <div class="box">
                <img src="images/pic5.jpg" alt="">
                <h3>Ample Resources</h3>
                <a href="#k5" class="btn">Read More</a>
            </div>

            <div class="box">
                <img src="images/pic6.jpg" alt="">
                <h3>New Technical Skills</h3>
                <a href="#k6" class="btn">Read More</a>
            </div>
